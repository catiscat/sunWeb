...
<html>
  <head>
    ...
    <link rel='stylesheet' href='http://www.dogduck.lol/css/base.css' type='text/css'  />
  ...
  <body>
    ...
    <div class="div1">
      <div class="div2">
        <div class='contentDiv'>
          <?php 
	          ...
	          require_once dirname(__FILE__)."/content/template/../../includes/PostService.class.php";
	          require_once dirname(__FILE__)."/content/template/../../includes/RollPage.class.php";
              	  require_once dirname(__FILE__)."/content/template/../../includes/commen.php";
	    ...
	    <div class='goTopDiv'>
		<a href='blogList.php#'><img class='goTop' src='images/goTop.ico' /></a>
		</div>
	    <div class="footerDiv">
       <footer>
      ...
      <div class="div3">
        ...
        <div class="div5">
			<?php 
				require_once dirname(__FILE__)."/content/template/../themes/default/languages/articleList.css.php";
