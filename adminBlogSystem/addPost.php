<html>
    ...
    <form action="postProcess.php" method="post">
        <table>
            ...
            <tr><td>post_date</td><td><input type="text" name="post_date" value='0' /></td></tr>
	        <tr><td>post_title</td><td><input type="text" name="post_title" /></td></tr> 
            <tr><td>post_type</td><td><input type="text" name="post_type" /></td></tr> 
            <tr><td>post_content</td><td><textarea rows="60000" cols="500" type="text" name="post_content" ></textarea></td></tr>
